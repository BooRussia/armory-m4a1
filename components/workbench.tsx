...
import { DEFAULT_ASSET, SHOWCASE_ASSET, ASSET_STORAGE_KEY, SURFACE_WEAR, readAssetAppearances, assetExport, readAssetExport, type SurfaceWear, type AssetAppearance, type SavedAssetAppearance } from '@/lib/asset-appearance';
