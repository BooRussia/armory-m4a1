...
The live Three.js renderer now adds a material-specific detail layer over the existing glTF artwork. In Settings, **Surface wear** selects Fresh, Used (default), or Worn. This choice follows saved appearances, export/import, Undo and Redo. Fresh removes the new wear layer; wear already painted into the original artwork remains.
