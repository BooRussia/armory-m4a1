...
for(const asset of ['assets/studio.hdr','assets/m4a1/m4a1-blender-v2.glb','assets/m4a1/hhs-viii.glb','assets/m4a1/exterior-variants.glb','.nojekyll'])assert.ok(existsSync(join(output,asset)),asset);
